  ...
  return (
    <ScrollView className={'bg-black'}>
      <SafeAreaView className={'w-screen bg-black'}>
        ...
        />
        <OneAchievement checked>Add Deal</OneAchievement>
        <OneAchievement checked={false}>Add 30 deal's</OneAchievement>
        ...
        <OneAchievement checked={false}>Top 1 on added list</OneAchievement>
      </SafeAreaView>
    </ScrollView>
  );
};
