...
export const Search = ({navigation, route} : Props) => {
  ...
  return (<SafeAreaView className={'bg-black w-screen h-screen p-10'}>
    <ScreenNameWBackArrow screenName={""} onPress={navigation.goBack} />
    <CustomInput customStyles={'min-w-full'} value={inputValue} setter={setInputValue} defaultValue={"Search here.."}/>
    <SearchExamples/>
  </SafeAreaView>);
}
